    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), imports = _a[0], schemaTypes = _a[1], operationTypings = _a[2];
                    console.log(imports, '\n');
...
function generateOperationMethodTypings(api, exportTypes) {
    ...
    var operationTypings = operations.map(function (op) { return generateMethodForOperation(op.operationId, op, exportTypes); });
