...
var testsDir = path_1.default.join(rootDir, '__tests__');
var examplePetAPIYAML = path_1.default.join(testsDir, 'resources', 'example-pet-api.openapi.yml');
describe('typegen', function () {
    var imports;
    var schemaTypes;
    var operationTypings;
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var types;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, typegen_1.generateTypesForDocument(examplePetAPIYAML)];
                case 1:
                    types = _a.sent();
                    imports = types[0];
                    schemaTypes = types[1];
    ...
    test('generates type files from valid v3 specification', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    test('exports OperationMethods', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    test('exports PathsDictionary', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    test('exports a Client', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
//# sourceMappingURL=typegen.test.js.map