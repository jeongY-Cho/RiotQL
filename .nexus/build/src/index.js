...
require("./schema/mutatation/tournament-code-stub");
require("./schema/mutatation/tournament-code");
require("./schema/mutatation/tournament-provider-stub");
require("./schema/mutatation/tournament-provider");
require("./schema/mutatation/tournament-registration-stub");
require("./schema/mutatation/tournament-registration");
require("./schema/mutatation/tournament-update");
